...
export default function StudentQueriesPage() {
    ...
    const exampleQueries = [
        { label: 'SELECT básico', query: 'SELECT * FROM usuarios LIMIT 10;' },
        { label: 'Mostrar tablas', query: 'SHOW TABLES;' },
        { label: 'Describir tabla', query: 'DESCRIBE nombre_tabla;' },
        ...
        <div className="min-h-screen bg-black">
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                <div className="mb-8 animate-fade-in-down">
                    <h1 className="text-4xl font-bold text-white mb-2">Ejecutar Queries SQL</h1>
                    <p className="text-gray-400">
                        Practica y ejecuta consultas SQL en tus instancias asignadas
                    </p>
                </div>
                ...
                {instances.length === 0 ? (
                    <div className="bg-gray-900 border border-gray-800 rounded-2xl p-12 text-center animate-fade-in-up">
                        ...
                        <p className="text-gray-500 text-sm mb-6">
                            Contacta a tu profesor para que te asigne una instancia de base de datos
                        </p>
                                ...
                                {selectedInstanceId && (
                                    <div className="bg-gradient-to-br from-purple-900 to-blue-900 bg-opacity-30 border border-purple-500 border-opacity-50 rounded-lg p-4 mb-6">
                                        ...
                                        <p className="text-sm font-bold text-white">
                                            {instances.find(i => i.instanceId === selectedInstanceId)?.instanceName}
                                        </p>
                                    </div>
                                )}
                                        ...
                                        <div>
                                            ...
                                            {result.data && result.data.length > 0 ? (
                                                <div>
                                                    ...
                                                    <div className="mt-3 flex items-center justify-between text-sm text-gray-400">
                                                        ...
                                                        <span className="bg-gray-800 px-3 py-1 rounded-full">
                                                            {result.columns?.length || 0} columnas
                                                        </span>
                                                    </div>
                                                </div>
                                            ) : (
                                                <div className="text-center py-8 bg-gray-800 bg-opacity-50 rounded-lg border border-gray-700">
                                                    ...
                                                    <p className="text-gray-500">La consulta no devolvió resultados</p>
                                                </div>
                                            )}
                                        </div>
                                    ) : (
                                        <div className="bg-red-900 bg-opacity-30 border border-red-500 border-opacity-50 text-red-300 px-4 py-3 rounded-lg">
                                            <div className="flex items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm mt-1 font-mono bg-black bg-opacity-50 p-2 rounded mt-2">
